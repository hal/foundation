...
/**
 * Factory that creates the appropriate {@link FormItem} subclass for a given resource attribute based on its type, allowed
 * values, capability references, and security constraints.
 */
