...
/**
 * Composite matcher that claims OBJECT attributes with the time-unit structure: a value-type containing {@code time} (LONG) and
 * {@code unit} (STRING) sub-attributes. Covers the {@code keepalive-time} attribute across thread pool resources.
 */
class TimeUnitMatcher implements AttributeMatcher {
