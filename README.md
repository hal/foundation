...
1. Build or use the latest feature pack from Maven Central [
   `org.jboss.hal:hal-op-feature-pack:0.3.6`](https://central.sonatype.com/artifact/org.jboss.hal/hal-op-feature-pack)
...
op/standalone/target/hal-op-standalone-0.3.6-runner
```
...
`org.jboss.hal:hal-op-standalone:0.3.6`](https://central.sonatype.com/artifact/org.jboss.hal/hal-op-standalone). You can
download and run it with

```shell
mvn dependency:copy -Dartifact=org.jboss.hal:hal-op-standalone:0.3.6:jar:runner -DoutputDirectory=.
java -jar hal-op-standalone-0.3.6-runner.jar
```
...
```shell
jbang org.jboss.hal:hal-op-standalone:0.3.6:runner
```
