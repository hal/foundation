...
1. Build or use the latest feature pack from Maven Central [
   `org.jboss.hal:hal-op-feature-pack:0.4.0`](https://central.sonatype.com/artifact/org.jboss.hal/hal-op-feature-pack)
...
`org.jboss.hal:hal-op-standalone:0.4.0`](https://central.sonatype.com/artifact/org.jboss.hal/hal-op-standalone). You can
